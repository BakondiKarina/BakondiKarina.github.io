...
let logoImg = document.querySelector('.navbar__logo-img');
let styles = window.getComputedStyle(logoImg);
console.log(styles);
...
const modal = document.getElementById('serviceModal');
    ...
    window.addEventListener('click', function(event) {
        if (event.target === modal) {
            modal.style.display = 'none'; // Ha a modál hátterére kattintanak, akkor is bezárul
        }
    });
